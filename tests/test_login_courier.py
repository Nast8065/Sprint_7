...
class TestLoginCourier:
    ...
    def test_courier_login_without_parameters_failed(self, courier_data):
        response = requests.post(f'{Urls.Yandex_Scooter_URL}{Endpoints.login_courier}', data=courier_data)
    ...
    def test_courier_login_without_null_login_failed(self):
        response = requests.post(f'{Urls.Yandex_Scooter_URL}{Endpoints.login_courier}', data=DataCourier.null_data_login)
